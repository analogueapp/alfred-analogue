...
def png_to_icns(png_path, icns_path):
    ...
    try:
        ...
        assert not os.path.exists(iconset), "iconset already exists: " + iconset
        os.makedirs(iconset)
        ...
        assert os.path.exists(icns_path), "generated ICNS file not found: " + repr(
            icns_path
        )
    finally:
        try:
...
if __name__ == "__main__":  # pragma: nocover
    ...
    if o.png:
        ...
        assert not os.path.exists(icns), "destination file already exists: " + icns
